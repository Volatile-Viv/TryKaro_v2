  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              <img
                src={
                  user?.avatar || "https://via.placeholder.com/150?text=User"
                }
                alt={user?.name}
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">
            Recommended Products To Test
          </h2>
        </div>
        <div className="p-6">
          <p className="text-gray-600 mb-4">
            Based on your testing history and preferences, we recommend these
            products for you to test next:
          </p>

          {/* This would be dynamically populated based on user preferences */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link
              to="/products"
              className="block bg-gray-50 hover:bg-gray-100 p-4 rounded-lg transition"
            >
