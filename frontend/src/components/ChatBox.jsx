...
const ChatBox = () => {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      ...
      {/* Chat box */}
      {isOpen && (
        <div className="absolute bottom-16 right-0 w-80 bg-white rounded-lg shadow-xl overflow-hidden flex flex-col transition-all duration-300 ease-in-out transform h-[450px]">
          {/* Header */}
          <div className="bg-blue-600 text-white p-4 flex justify-between items-center">
            <h3 className="font-medium">Website Support Chat</h3>
            <button
              onClick={toggleChat}
          ...
          <div className="flex-1 p-4 overflow-y-auto h-[330px] space-y-3 scrollbar-thin scrollbar-thumb-blue-200 scrollbar-track-transparent">
              ...
              <div className="flex justify-start">
                <div className="bg-gray-100 p-3 rounded-lg text-gray-800">
                  <span className="flex items-center">
                    ...
                    <span className="animate-pulse mx-2 delay-75">●</span>
                    <span className="animate-pulse ml-2 delay-150">●</span>
                  </span>
                </div>
              </div>
            )}
          ...
          <form onSubmit={handleSendMessage} className="border-t p-3 flex">
            ...
            <button
              ...
              } text-white px-4 py-2 rounded-r-lg focus:outline-none transition-colors`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
