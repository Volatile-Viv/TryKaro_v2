              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex space-x-1">
                  <button
                    ...
                    className="px-2 py-1 rounded bg-blue-600 hover:bg-blue-700 text-sm text-white transition-colors focus:outline-none"
                  >
                    Add
                  </button>
                  <button
                    onClick={() => setShowQuantity(false)}
                    className="px-2 py-1 rounded bg-gray-200 hover:bg-gray-300 text-sm text-gray-700 transition-colors focus:outline-none"
                  >
                    Cancel
                  </button>
                </div>
